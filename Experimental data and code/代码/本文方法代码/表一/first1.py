...
if __name__ == '__main__':
    ...
    target = [
['Afforestation', 'Building-integrated photovoltaics', 'Intergovernmental Panel on Climate Change', 'Sea ice', 'United Nations Environment Programme', 'World Health Organization'],
['Bangladesh', 'Caribbean', 'Costa Rica', 'Egypt', 'São Tomé and Príncipe'],
['Pacific Ocean', 'Tropics'],
["Côte d'Ivoire", 'Geographical pole', 'Methane'],
['Landform'],
['Iceland', 'Indonesia', 'Transition economy', 'United Nations Convention to Combat Desertification'],
['Hydrology', 'Intergovernmental organization']]
