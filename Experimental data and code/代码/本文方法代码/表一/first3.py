...
if __name__ == '__main__':
    ...
    f = open("first3.txt", "w")
    word = ["United Nations Framework Convention on Climate Change","Greece","Greenhouse gas inventory","Methane","South Africa","United States","Earth Summit","Nusa Dua","Human impact on the environment"]
    for I in range(1):
        start = timeit.default_timer()
        A = word[I]
        A_title = summary(A)
