...
if __name__ == '__main__':
    ...
    word = ["Parallel postulate","Euclidean geometry","Euclid's Elements","Consistency","Ptolemy","Mathematics in medieval Islam","Lewis Carroll","Right angle","Mathematician","Spherical geometry","Parallel (geometry)","Angle","Hyperbolic geometry"]
    for I in range(1):
        start = timeit.default_timer()
        A = word[I]
        A_title = summary(A)
