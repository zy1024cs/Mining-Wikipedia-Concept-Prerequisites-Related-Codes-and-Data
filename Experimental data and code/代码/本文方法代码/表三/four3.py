...
if __name__ == '__main__':
    ...
    f = open("four3.txt", "w")
    word = ["Parallel postulate","John Playfair","Proclus","Transformation (function)","Eugenio Beltrami","Axiom","Euclid","Triangle","Line (geometry)","Unconscious mind","Non-Euclidean geometry","Internal and external angle","Congruence (geometry)","Nasir al-Din al-Tusi","Rome"]
    for I in range(1):
        start = timeit.default_timer()
        A = word[I]
        A_title = summary(A)
