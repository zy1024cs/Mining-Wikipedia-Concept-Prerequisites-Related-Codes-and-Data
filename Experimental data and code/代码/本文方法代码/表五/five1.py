...
if __name__ == '__main__':
    ...
    word = ["Symmetric-key algorithm","Message authentication code","Algorithm","Initialization vector","Stream cipher","Cryptographic primitive","Key (cryptography)","CBC-MAC"]
    for I in range(1):
        start = timeit.default_timer()
        A = word[I]
        A_title = summary(A)
